  ...
  useEffect(() => {
    ...
    const createSpinTimeline = () => {
      ...
      spinTl.current = gsap
        ...
        .to(cursor, { rotation: '+=360', duration: spinDuration, ease: 'linear' });
    };
    ...
    const mouseDownHandler = () => {
      ...
      gsap.to(dotRef.current, { scale: 0.7, duration: 0.05 });
      gsap.to(cursorRef.current, { scale: 0.9, duration: 0.05 });
    };

    const mouseUpHandler = () => {
      if (!dotRef.current) return;
      gsap.to(dotRef.current, { scale: 1, duration: 0.05 });
        ...
        resumeTimeout = setTimeout(() => {
          if (!activeTarget && cursorRef.current && spinTl.current) {
            ...
            spinTl.current = gsap
              ...
              .to(
              cursorRef.current,
              { rotation: '+=360', duration: spinDuration, ease: 'linear' }
            );
